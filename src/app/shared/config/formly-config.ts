...
export function fieldMatchValidator(control: AbstractControl) {
  ...
  return password_confirm === password ? null : { fieldMatch: true };
};
  ...
  return {
    ...
    validationMessages: [
      ...
      },
      {
        name: 'minLength',
        message() {
          return translate.stream(_('GLOBAL.FORM_VALIDATION.MIN_LENGTH'), { minLength: constants.MIN_LENGTH_TEXT_INPUT });
        }
      },
      {
        name: 'maxLength',
        message() {
          return translate.stream(_('GLOBAL.FORM_VALIDATION.MAX_LENGTH'), { maxLength: constants.MAX_LENGTH_TEXT_INPUT });
        }
      },
      {
        name: 'email',
    ...
    types: [
      ...
      { name: "file-field", component: FileFieldComponent, wrappers: ["form-field"] },
